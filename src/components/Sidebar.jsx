      ...
      items: [
        {
          ...
          icon: <Users size={18} />,
          path: "/users",
          permission: "ver-modulo-usuarios",
        },
        {
          name: "Roles",
          icon: <ShieldCheck size={18} />,
          path: "/roles",
          permission: "ver-modulo-roles",
        },
      ],
    },
    {
      ...
      items: [
        {
          ...
          path: "/beneficiarios",
          permission: "ver-modulo-beneficiarios",
        },
        {
          name: "Actividades",
          icon: <SquareActivity size={18} />,
          path: "/actividades",
          permission: "ver-modulo-actividades",
        },
        {
          name: "Asistencias",
          icon: <CalendarCheck size={18} />,
          path: "/asistencias",
          permission: "ver-modulo-asistencias",
        },
      ],
    },
    {
      ...
      items: [
        {
          ...
          path: "/calendario",
          permission: "ver-calendario-actividades",
        },
        {
          name: "Cumpleaños",
          icon: <CalendarDays size={18} />,
          path: "/cumpleanos",
          permission: "ver-calendario-cumpleaños",
        },
      ],
    },
  ];
